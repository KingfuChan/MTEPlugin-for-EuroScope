...
const std::set<CString> m_CHNCallsign = {
	"ALP","AYE","BDJ","BGC","BJN","BJV","BNH","BSH","BYC","CAG",
	"CAL","CAO","CBG","CBJ","CCA","CCD","CCO","CDC","CDG","CES",
	"CFA","CFB","CFI","CFJ","CFZ","CGH","CGN","CGZ","CHB","CHC",
	"CHH","CJX","CKK","CMJ","CNJ","CNM","CNW","CQH","CQN","CSC",
	"CSH","CSN","CSS","CSY","CSZ","CTE","CTH","CUA","CUH","CWR",
	"CWU","CXA","CXH","CXI","CXJ","CXN","CYH","CYN","CYZ","DBH",
	"DER","DGA","DKH","DLC","DXH","EPA","EPB","FSJ","FTU","FZA",
	"GCR","GDC","GSC","GWL","HAH","HBH","HFJ","HHG","HKG","HLF",
	"HTK","HTU","HXA","HYT","HZX","ICU","JAE","JBE","JGJ","JKT",
	"JOY","JYH","KNA","KPA","KXA","LHA","LKE","MJC","MMJ","MSF",
	"MZT","NEJ","NMG","NSJ","OKA","OTC","OTT","QDA","QSR","RBW",
	"RLH","SHQ","SJM","SNG","TBA","TXJ","UEA","UNA","UTP","WFH",
	"WUA","XAI","YZR","CSG"
};
